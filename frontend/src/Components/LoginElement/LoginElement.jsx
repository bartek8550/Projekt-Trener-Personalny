...
const LoginElement = () => {
  return (
    <div className="max-w-6xl min-h-[43.5vh] mx-auto pt-[5vh] pb-[5vh] flex flex-row">
      <div className="basis-1/2 mx-4 flex flex-col flex-wrap justify-center items-end mr-5">
        <div className="flex flex-col items-left mb-2">
          <h1 className="mr-2">Adres email:</h1>
          <input
            className="border border-solid border-black w-[300px]"
            type="text"
            required
          />
        </div>
        ...
        <div className="grid grid-cols-2 justify-items-start w-[300px]">
          <button
            type="button"
            className="
      ...
      <div className="basis-1/2 flex flex-col justify-center ml-5">
        <p>Nie masz konta?</p>
